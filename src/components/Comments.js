...
// import { CommentsData } from '../utils/commentsMock'

// export const Comments = ({data}) => {
//     const {author,comments} = data;
//   return (
   
//         <div className='flex my-5 shadow-xl border border-slate-400'>
//         <div>
//         <img
//           className="h-9 w-10 my-2"
//           alt="user"
...
//         <CommentList key={CommentsData.id} comments={CommentsData}/>
//         </div>
//     )
// }
...
const CommentList = ({ comments }) => {
  // Ensure comments is always an array before attempting to map over it
